...
das dir erlaubt eine \href{http://de.wikipedia.org/wiki/Morsezeichen}{Morsebotschaft} zu verschicken.
...
Das Ereignis-Aktions Paar: \blkc{clap} 
...
Der Thymio enthält ein Berührungssensor, welcher ein Ereignis auslöst \blksm{event-tap}, falls dem Roboter kurz auf seine Oberseite geklopft wird. So bewirkt zum Beispiel das Ereignis-Aktions Paar 
\blkc{touch}
...
und eines für das folgende Paar \blkc{clap} welches die Bodenlichter angehen lässt,
wenn Du in die Hände klatschst.
...
\vspace{.5em}\\
\textbf{Versichere dich}, dass der Roboter \textbf{langsam} fährt und sich dadurch nicht selbst beschädigt.
}