...
Da jedes der vier Viertel entweder ein- oder ausgeschaltet sein kann, sind 16 verschiedene Zustände möglich.
...
Die Figur~\ref{fig.state-leds} zeigt den Roboter mit den Zuständen \bu{(ein, ein,
ein, ein)}.
