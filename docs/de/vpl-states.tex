...
Die Bedeutung von
\blk{tap-state-off} 
ist: \emph{Falls} der Roboter berührt wird im Zustand \bu{eingeschaltet}, ändere den Zustand auf \bu{ausgeschaltet}: \blkc{tap-state-off}
