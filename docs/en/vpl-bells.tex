...
The Thymio-II has a microphone. The event \blksm{event-clap} will occur
...
Thymio-II contains a tap sensor that causes the event \blksm{event-tap} to
...
that turns on the bottoms lights when you clap your hands: \blkc{clap}
