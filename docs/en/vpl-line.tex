...
First, we cause the Thymio to move forward whenever \emph{both} sensors detect
...
meters), so that the Thymio can stay connected to the computer even
as it moves.
You can find extension cables in any computer shop.}
