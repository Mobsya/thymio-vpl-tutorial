...
\trickbox{We assume that the table is colored with a light color.
If your table is colored with a dark color, you will have to modify the program.
Avoid transparent glass tables, as they will likely not reflect the light and Thymio-II will believe that it is not on a table!
}
