...
\trickbox{Use a table colored with a light color, but don't use a glass table, as it will likely not reflect the light and Thymio will believe that it is not on a table!}
...
\trickbox[Information]{The gray, red and white colors used in a block are
arbitrary and others could have been chosen.}
...
solution was to place a strip of black tape close to the
edge of the desk.
}