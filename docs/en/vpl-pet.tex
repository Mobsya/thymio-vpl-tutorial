...
such as \blk{turning}. Set the left and right sliders, run the program
...
{\raggedleft \hfill Program file \bu{likes}.}
...
{\raggedleft \hfill Program file \bu{does-not-like}.}
