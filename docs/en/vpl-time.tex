...
\chap{A Time to Like}\label{ch.time}
...
the right when the timer runs down: \blkc{turn-back}
...
backwards. Add an event-action pair to stop the robot by touching the
center button.
}
