...
La paire événement-actions suivante allumera les lumières en dessous du robot lorsque vous tapez dans vos mains: \blkc{clap-lights}
...
\vspace{.5em}\\
Écrivez un programme qui fasse l'opposé : le robot démarre lorsque vous touchez un bouton et s'arrête lorsque vous tapez dans vos mains.
}
