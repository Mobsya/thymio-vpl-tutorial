...
\trickbox[Information]{
En mixant ensemble du rouge, du vert et du bleu, vous pouvez faire n'importe quelle couleur (\cref{fig.cube}) !
}
...
\item Lorsqu'un programme est lancé, toutes les paires d'événement-actions sont actives.
