...
Les projets suivants utilisent l'événement frapper des mains \blksm{event-clap} pour changer l'état de Thymio et il est représenté par le cercle de lumières.
N'hésitez pas à changer n'importe lequel de ces éléments.

\importantbox{Par défaut, l'état du robot est affiché grâce au cercle de LEDs en dessus du robot.
