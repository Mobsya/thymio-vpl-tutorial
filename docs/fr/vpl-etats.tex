...
\begin{figure}[h]
    \centering
    \subfigure[Une tape pour allumer ou éteindre]{ \label{fig.state-changing-a} \includegraphics[width = 0.35\textwidth]{tap-on-off1}}
    \hspace{1cm}
    \subfigure[Une tape pour changer d'état]{ \label{fig.state-changing-b} \includegraphics[width = 0.35\textwidth]{tap-on-off2}}
...
\begin{figure}[h]
    ...
    \hspace{1cm}
    \subfigure[La lumière indique le mode de Thymio]{\label{fig.state-leds} \includegraphics[width = 0.35\textwidth]{state-leds}}
...
\begin{itemize}
	\item Le \textbf{premier mode} est l'\textbf{arrêt}. Thymio est arrêté, il attend qu'on appuie sur son bouton central pour lancer la recherche. L'état du cadran associé à ce mode est \includegraphics[scale=0.3]{Mode1}
	\item Le \textbf{deuxième mode} est la \textbf{recherche}. Thymio cherche l'objet en tournant sur lui-même. Il ne sortira de ce mode que lorsqu'il verra l'objet sur son capteur tout à droite. L'état du cadran associé à ce mode est \includegraphics[scale=0.3]{Mode2}
	\item Le \textbf{troisième mode} est l'\textbf{alignement}. Thymio tourne dans l'autre sens pour s'aligner avec l'objet. Il ne sortira de ce mode que lorsqu'il verra l'objet en face de lui. L'état du cadran associé à ce mode est \includegraphics[scale=0.3]{Mode3}
\end{itemize}
...
\begin{figure}[h]
    \centering
    \subfigure[]{\includegraphics[width = 0.35\textwidth]{homing_thymio}} 
    \hspace{1cm}
    \subfigure[]{\includegraphics[width = 0.35\textwidth]{homing_thymio2}}
