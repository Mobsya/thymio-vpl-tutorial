...
\textbf{Ouvrir} \blksm{open}: Cliquez pour ouvrir un projet existant dans VPL.
...
\textbf{Annuler} \blksm{undo}: Annuler la dernière action comme par exemple la suppression
d'une paire événement-actions.\label{p.undo}

\bigskip

\textbf{Rétablir} \blksm{redo}: Rétablir la dernière action qui a été annulée.

\bigskip

\textbf{Lancer} \blksm{run}: Lancer le programme actuel.
