...
\item Pour copier une paire événement-actions vers un deuxième endroit dans le programme, appuyez et maintenez pressé la touche \bu{Ctrl} et utilisez votre souris pour glisser et déposer la paire à l'emplacement désiré.\label{p.copy-pair}\footnote{Sur Mac OS, la touche \bu{Command} remplace la touche \bu{Ctrl}.}
\end{itemize}
...
\newpage
\sect{La paire événement-actions sélectionnée}
...
La pair au fond jaune est appelée la paire sélectionnée.
