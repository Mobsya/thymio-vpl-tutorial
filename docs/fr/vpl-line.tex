...
Que se passe-t-il ?
\vspace{.5em}\\
Il serait bien de pouvoir se \emph{rappeller} quel capteur était le dernier à perdre le contact avec la ligne afin de tourner le robot dans la bonne direction pour retrouver la ligne.
