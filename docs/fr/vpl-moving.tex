...
Cliquez sur le bouton \blksm{stop} pour arrêter Thymio.
...
\trickbox{
Utilisez une table est de couleur claire ou fixez des feuilles de papier blanc sur la table. Évitez les tables en verre transparent, elles ne réfléchiront probablement pas la lumière et Thymio croira qu'il n'est pas sur une table !}

Glisser-déposer le bloc détecteur de sol \blksm{event-prox-ground} sur la zone de programmation pour commencer.
