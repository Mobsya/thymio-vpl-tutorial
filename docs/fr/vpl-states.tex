...
Dans la première paire événement-actions (\cref{fig.turn-on-off1}), l'événement est composé du bloc détection de choc avec une indication d'état \blksm{state-filter}.
...
\end{quote}
La \cref{fig.all-states} donne tous ces états.
