...
Scrivi un programma che vi permetterà di inviare un messaggio in \href{http://en.wikipedia.org/wiki/Morse_code}{codice Morse}.
...
\sect{Controlla il tuo robot con i suoni}
...
Scrivi un programma che faccia andare avanti il robot fino a quando non colpisce una
parete.
\vspace{.5em}  \\
\textbf{Assicurati} che il robot si \textbf{muova lentamente} in modo che
non si danneggi.
}
