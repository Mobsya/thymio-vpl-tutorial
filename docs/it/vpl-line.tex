...
\trickbox{Assicurati di utilizzare un cavo USB che sia abbastanza lungo (diciamo, due
...
come quello mostrato nella \cref{fig.tape}. Prova ad aumentare la
...
Discuti su che effetto le seguenti modifiche di Thymio potrebbero
