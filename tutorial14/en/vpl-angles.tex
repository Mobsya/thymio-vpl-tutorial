...
\item \blksm{event-acc-roll}: An event occurs when the left / right
angle of the robot is within the red segment of the half-circle.

\item \blksm{event-acc-pitch}: An event occurs when the forward /
...
\exercisebox{\thechapter.1}{Can two events use the same red segment of
angles?\\
