...
\chap{Project: Finite Automata}\label{ch.fa}
...
know how to format a document using \LaTeX{}. The files \p{\footnotesize
fa-path-*.tex} contain the \LaTeX{} source code. 
...
Format the file with \p{pdflatex} and print the output using software
