...
AESL, you can read the
\href{https://aseba.wikidot.com/en:thymiotutoriel}{AESL tutorial}
(\url{http://aseba.wikidot.com/en:thymiotutoriel}), and the document
\href{https://aseba.wdfiles.com/local--files/en:thymioprogram/vpl-to-aesl.pdf}{
\textit{From Programming in VPL to Programming in AESL}}
(\url{https://aseba.wdfiles.com/local--files/en:thymioprogram/vpl-to-aesl.pdf}),
which introduces AESL by explaining the translations of the programs
in this tutorial.}
...
hold the left mouse button and drag the block to a square. When the
block is in place, release the mouse button.

Start by bringing the button event block \blksm{event-buttons} into the
left side of the empty frame. You will get an error message that the
action is missing. Now, bring the top color action block
\blksm{action-colors-up} into the right side of the frame. You have
