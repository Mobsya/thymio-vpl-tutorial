...
\blkc{stop-motors} That will stop the motors when the center button is
...
\trickbox{Use a table colored with a light color, but don't use a glass
table, as it will likely not reflect the light and Thymio will believe
that it is not on a table!}
...
\trickbox{ When I ran the program, the robot \emph{did} fall off. The
...
solution was to place a strip of black tape close to the edge of the
desk.}
